...
void mqttconnect() {
  ...
  while (!client.connected()) {
    ...
    // connect now 
    if (client.connect("ESP32 UNIT_2", "","")) {
      Serial.println("connected");
      // subscribe topic with default QoS 0
      client.subscribe("LED_2");
      client.subscribe("FastLED_2");
      client.subscribe("SSID_2");
      client.subscribe("PASS_2");
      client.subscribe("CLIENTID_2");
      client.subscribe("Besedilo_2");
    } else {
...
void printValues() {
    ...
    client.publish("Temperature_2", String(bme.readTemperature()).c_str());
    //Serial.println(" *C");

    //Serial.print("Pressure = ");

    //Serial.print(bme.readPressure() / 100.0F);
    client.publish("Pressure_2", String(bme.readPressure()/100.0F).c_str());
    //Serial.println(" hPa");

    //Serial.print("Approx. Altitude = ");
    //Serial.print(bme.readAltitude(SEALEVELPRESSURE_HPA));
    client.publish("Altitude_2", String(bme.readAltitude(SEALEVELPRESSURE_HPA)).c_str());
    //Serial.println(" m");

    //Serial.print("Humidity = ");
    //Serial.print(bme.readHumidity());
    client.publish("Humidity_2", String(bme.readHumidity()).c_str());
    //Serial.println(" %");
